...
#%%
#Set prefix
datasetPath = "TwoHundredThousand_Resorted"
...
learning_rate = 0.001
epochs = 40
data_directory = datasetPath
train_from_scratch = True
name = datasetPath + ("from_scratch" if train_from_scratch else "pretrained")
print(name)
##
...
model.save("efficientNet_" + name + ".h5")
...
test_model = load_model("efficientNet_" + name + ".h5")

#%%
#Load different model

from tensorflow.keras.models import load_model
test_model = load_model("hists/binary_effnet_23_05__95%.h5")
...
test_model.save("efficientNet.kerasmodel")
